    ...
    <div className="min-h-screen flex flex-col items-center justify-center relative w-full">
      ...
      >
        <p className="text-white/70 text-lg leading-relaxed">
          Подготовься к интервью на позицию Data/Product Analyst: несколько задач подряд в одной сессии и один развёрнутый разбор в конце — как на настоящем техническом собесе.
        </p>
      </motion.div>
          ...
          >
            ...
            >
              ...
              <p className="text-white/80 text-sm leading-relaxed mb-4">
                Сервис для аналитиков, которые готовятся к техническим собеседованиям. В базе — сотни задач из реальных интервью: часть мы проходили сами, часть задавали как нанимающие менеджеры. За одну сессию вы решаете несколько задач подряд; подробный разбор по всем ответам приходит один раз в конце — его формирует языковая модель под сценарий мок-интервью. Нам важен ваш фидбек — пишите в{' '}
                <a
