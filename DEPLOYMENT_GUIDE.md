...
| Файл | Описание |
|------|----------|
| `user.py` | Модель пользователя (id, clerk_user_id, вопросы, триал) |
...
| Файл | Описание |
|------|----------|
| `auth.py` | **Авторизация**: `/auth/register`, `/auth/status`, `/auth/me`. Работа с Clerk JWT токенами |
...
| Файл | Описание |
|------|----------|
| `auth.py` | Логика авторизации: верификация Clerk токенов, создание пользователей |
...
| `layout.tsx` | — | **Общий layout**. Обёртка для всех страниц (Clerk Provider, шрифты, метаданные) |
...
Middleware для Clerk авторизации. Защищает определённые роуты.
